...
public class Main {
	...
	{		
        ...
        TipoMoneda tipoCuenta1 = new TipoMoneda("Peso");
        TipoMoneda tipoCuenta2 = new TipoMoneda("Dolar");

    	Cuenta cuenta = new Cuenta ("11101010", "winrar.licencia", tipoCuenta1, 1044.5, true, cliente, date, "C/ahorro");
    	Cuenta cuenta1 = new Cuenta ("12101010", "winrar.auto", tipoCuenta1, 1004.5, true, cliente1, date, "C/ahorro");
    	Cuenta cuenta2 = new Cuenta ("13101010", "winrar.pirata", tipoCuenta1, 1004.5, true, cliente2, date, "C/ahorro");
    	Cuenta cuenta3 = new Cuenta ("131401010", "winrar.nunca.pago", tipoCuenta1, 1004.5, true, cliente3, date, "C/ahorro");
    	Cuenta cuenta4 = new Cuenta ("16101010", "winrar.nada", tipoCuenta2, 1054.5, true, cliente4, date, "C/ahorro");
    	Cuenta cuenta5= new Cuenta ("10161710", "winrar.exe", tipoCuenta2, 1004.5, true, cliente5, date, "C/ahorro");
    	Cuenta cuenta6 = new Cuenta ("1010177010", "winrar.rawson", tipoCuenta1, 1004.5, true, cliente6, date, "C/ahorro");
    	Cuenta cuenta7 = new Cuenta ("19181010", "winrar.doc", tipoCuenta2, 1004.5, true, cliente7, date, "C/ahorro");
    	Cuenta cuenta8 = new Cuenta ("19171010", "winrar.rar", tipoCuenta2, 1004.5, true, cliente8, date, "C/ahorro");
    	Cuenta cuenta9 = new Cuenta ("101071910", "winrar.png", tipoCuenta1, 1094.5, true, cliente4, date, "C/ahorro");

    	
    	Movimiento movimiento = new Movimiento(10101.7 , 50005.7 , date, "deuda", cuenta);
    	Movimiento movimiento1 = new Movimiento(12001.7 , 50005.7 , date, "prestamo", cuenta1);
    	Movimiento movimiento2 = new Movimiento(13001.7 , 50005.7 , date, "ayuda", cuenta2);
    	Movimiento movimiento3 = new Movimiento(10401.7 , 50005.7 , date, "aporte", cuenta3);
    	Movimiento movimiento4 = new Movimiento(14001.7 , 50005.7 , date, "pack futbol", cuenta4);
    	Movimiento movimiento5 = new Movimiento(15001.7 , 50005.7 , date, "deuda 2", cuenta4);
    	Movimiento movimiento6 = new Movimiento(10501.7 , 50005.7 , date, "particular", cuenta6);
    	Movimiento movimiento7 = new Movimiento(10401.7 , 50005.7 , date, "bono", cuenta7);
    	Movimiento movimiento8 = new Movimiento(1031.7 , 50005.7 , date, "Cuota tusi", cuenta8);
    	Movimiento movimiento9 = new Movimiento(10101.7 , 50005.7 , date, "deuda", cuenta9);
    	Movimiento movimiento10 = new Movimiento(10101.7 , 50005.7 , date, "deuda", cuenta5);
